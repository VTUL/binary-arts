module Hyrax
  module WorksControllerBehavior
    ...
    def new
      ...
      curation_concern.composer = [current_user.user_key] if controller_name == "compositions"
      curation_concern.performer = [current_user.user_key] if controller_name == "performances"
